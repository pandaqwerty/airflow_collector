...
from userappos_collector.subdags.sub import all_process

PROJECT_VERSION = '1.0'
PROJECT_NAME = 'userappos-collector'

# MAIN DAGS
# interval = "0 3 */1 * *"
interval = "*/10 * * * *"
DAG_ID = 'userappos_collector'
start_date = datetime.strptime(Variable.get("userappos_collector_start_date"), "%Y-%m-%d %H:%M:%S")
