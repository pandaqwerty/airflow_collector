...
from review_products_collector.subdags.sub import all_process

PROJECT_VERSION = '1.0'
PROJECT_NAME = 'review-products-collector'

# MAIN DAGS
# interval = "0 3 */1 * *"
interval = "*/10 * * * *"
DAG_ID = 'review_products_collector'
start_date = datetime.strptime(Variable.get("review_products_collector_start_date"), "%Y-%m-%d %H:%M:%S")
