...
from comment_collector.subdags.sub import all_process

PROJECT_VERSION = '1.0'
PROJECT_NAME = 'comment-collector'

# MAIN DAGS
# interval = "0 3 */1 * *"
interval = "*/10 * * * *"
DAG_ID = 'comment_collector'
start_date = datetime.strptime(Variable.get("comment_collector_start_date"), "%Y-%m-%d %H:%M:%S")
