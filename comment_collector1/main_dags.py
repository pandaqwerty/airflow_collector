...
from comment_collector1.subdags.sub import all_process

PROJECT_VERSION = '1.0'
PROJECT_NAME = 'comment-collector1'

# MAIN DAGS
# interval = "0 3 */1 * *"
interval = "*/10 * * * *"
DAG_ID = 'comment_collector1'
start_date = datetime.strptime(Variable.get("comment_collector1_start_date"), "%Y-%m-%d %H:%M:%S")
